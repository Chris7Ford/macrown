<script type="text/javascript" src="{{ asset('js/main-navigation.js') }}" defer></script>
<link href="{{ asset('css/main-navigation.css') }}" rel="stylesheet" />

<main-navigation>
	<nav class="relative px-4 py-4 flex justify-between items-center bg-main-color mb-8 border-b-2 border-gray-600">
    <div class="flex items-start">
    <div class="lg:hidden">
			<button class="navbar-burger flex items-center text-purple-500 p-3">
    ...
    <h2 class="app-title lg:hidden text-white secondary-font text-2xl">
      Macrown
    </h2>
    </div>
		<ul class="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:flex lg:items-left lg:w-auto lg:space-x-6">
